...
public class submitOrdersServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int row = DaoFactory.excute(
				"update orders set Sid=2,note=? where id=?", note, oid);
		if (row > 0) {
			List<Map<String, Object>> ordSum = DaoFactory.excuteQuery(
					"select sum(o.money) sum from orderDetail o where o.Oid=?",
					oid);
			request.setAttribute("sum", ordSum);
