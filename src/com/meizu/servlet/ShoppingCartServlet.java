...
public class ShoppingCartServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Map<String, Object>> list = DaoFactory
				.excuteQuery(
						"select s.id, m.Cid,c.cover,c.name,s.num,m.money from ShoppingCart s left join Users u on s.Uid=u.id left join model m on s.Mid=m.id left join commodity c on  m.Cid=c.id where u.id="
								+ uid, null);
		request.setAttribute("ScartList", list);
